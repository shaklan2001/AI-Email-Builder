...
from app.models.common import ensure_utc_aware
...
class WorkflowRunRepository:
    ...
    def _doc_to_record(self, doc: dict[str, Any]) -> WorkflowRun:
        ...
        if not isinstance(updated_at, datetime):
            ...
            updated_at = ensure_utc_aware(updated_at)
        ...
        elif isinstance(next_execution_at, datetime):
            next_execution_at = ensure_utc_aware(next_execution_at)
        return WorkflowRun(
            id=run_id,
